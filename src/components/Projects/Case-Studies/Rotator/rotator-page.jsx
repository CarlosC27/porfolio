            ...
            <main className="rotator-page">
                ...
                <section className="the-challenge-section">
                    ...
                    <ul className="core-problems-list">
                        <li className="cpl-item"><b>Decision paralysis:</b> With an extensive portfolio spanning sculptures, websites, mobile design, murals, posters, branding, and print design, the team felt overwhelmed about which work to showcase</li>
                        <li className="cpl-item"><b>Competing priorities:</b> Client work consistently took precedence over their own website rebuild</li>
                        <li className="cpl-item"><b>Client work consistently took precedence over their own website rebuild:</b> Years of diverse, high-quality work made it difficult to create a cohesive story</li>
                    </ul>
                     <p><b>Evidence:</b> <em>The project folder was aptly named "rotator rebuild 2022,2023,2024" - a testament to how long this had been on their wishlist.</em></p>
                </section>
                <section className="my-role-and-approach">
                    <h2>My Role and Approach</h2>
                    <p>As the UX/UI Design Intern, I took ownership of bringing this project to life. Working closely with my mentor Kendon Shaw, I approached this as both a design and strategic content challenge.</p>
                ...
                <section className="phase-4">
                        ...
                        <div className="ph4-tx-and-img">
                            ...
                            <img src={Rtrtimgs.learning_ae} alt="the Adobe After Effect UI screen, logo, and drawing of a pencil"/>
                        </div>
                </section>
                <section className="rtr-animation">
                    <OregonCityAnimation/>
                </section>
